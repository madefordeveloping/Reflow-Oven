...
#define TEMPERATURE_SOAK_MAX 40 //200
#define TEMPERATURE_REFLOW_MAX 45 //250
...
Serial.begin(57600);
Serial.println("Init and Turn off SSR");
...
Serial.println("Reflow Oven 1.1");
...
Serial.println(input);
  ...
  if (millis() > nextCheck)
  {
    ...
    if (reflowStatus == REFLOW_STATUS_ON)
    {
      ...
      analogWrite(ledRedPin, !(analogRead(ledRedPin)));
...
Serial.println(lcdMessagesReflowStatus[reflowState]);    
  ...
  case REFLOW_STATE_IDLE:
		...
		else
		{
			...
			{
// Serial print Reflow has started
Serial.println("Reflow started");
        // Send header for CSV file
        Serial.println("Time Setpoint Input Output Temp");
